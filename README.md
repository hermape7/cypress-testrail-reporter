...
This is clone from [https://github.com/Vivify-Ideas/cypress-testrail-reporter](https://github.com/Vivify-Ideas/cypress-testrail-reporter). Thanks!
...
```shell
npm install hermape7/cypress-testrail-reporter --save-dev 
```

```shell
yarn install --save-dev hermape7/cypress-testrail-reporter
```
